...
set +o errexit
#time -p $PIN_ROOT/pin -ifeellucky -t $DIR/obj-*/numalize.so ${@}
#time -p $PIN_ROOT/pin -pause_tool 5 -t $DIR/obj-*/numalize.so ${@}
time -p $PIN_ROOT/pin -t $DIR/obj-*/detloc_tracer.so ${@}
retcode=$?
set -o errexit
